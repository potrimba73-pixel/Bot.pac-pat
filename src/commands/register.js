...
export async function registerCommands() {
    const commands = [
        new SlashCommandBuilder()
            .setName("apagar")
            .setDescription(
                "Apaga mensagens do bot em todos os canais ou em canais específicos",
            )
            ...
            .addStringOption((option) =>
                option
                    .setName("canais")
                    .setDescription(
                        "IDs dos canais separados por vírgula (deixe vazio para todos)",
                    )
                    .setRequired(false),
            )
            .toJSON(),
        ...
        new SlashCommandBuilder()
            ...
            .addUserOption((option) =>
                option
                    .setName("staff")
                    .setDescription("Membro da staff para quem passar o ticket")
                    .setRequired(true),
            )
            .toJSON(),
        new SlashCommandBuilder()
