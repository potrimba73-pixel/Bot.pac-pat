...
export async function sendPainelGeral(channel) {
    const embed = new EmbedBuilder()
        ...
        .setDescription([
            `:Portugal_Alfa_Community: **Olá! Seja Bem-vindo ao nosso sistema de tickets oficial do Portugal Alfa Community!**`,
            ...
            "`->` Entre Outros….",
            "",
            `:ban: **Qualquer descumprimento destas regras levará ao encerramento do ticket sem aviso prévio e dependendo das situações será usado a opção de timeout de um tempo indeterminado!**`,
            `:ets2: **Use mas não Abuse!**`
        ].join("\n"))
        .setColor(0x262af1)
